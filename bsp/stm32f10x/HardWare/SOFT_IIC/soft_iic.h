...
#define IIC_SDA_IN()			{GPIOB->CRH&=0XFFFFFF0F;GPIOB->CRH|=(u32)8<<4;}	//设置为输入模式或者开漏模式（外加上拉）
#define IIC_SDA_OUT()			{GPIOB->CRH&=0XFFFFFF0F;GPIOB->CRH|=(u32)3<<4;}	//设置成准双向或者推挽输出，最大速度50MHz
