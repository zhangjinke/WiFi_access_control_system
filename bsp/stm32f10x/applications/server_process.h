...
#define CMD_SERVER_ATT_GET      (0x05) /**< \brief 获取指定条数考勤信息 每次最多18条 */
#define CMD_SERVER_DOOR_OPEN    (0x06) /**< \brief 开门 */
#define CMD_SERVER_CONFIG_SET   (0x07) /**< \brief 下传配置信息 */
#define CMD_SERVER_LIST_RELOAD  (0x08) /**< \brief 重新加载卡号-用户号，指纹号-用户号列表 */
#define CMD_SERVER_ATT_DEL      (0x09) /**< \brief 删除指定条数考勤记录 */
#define CMD_SERVER_USER_CRC_GET (0x0A) /**< \brief 获取指定条数用户CRC 每次最多200条 */
